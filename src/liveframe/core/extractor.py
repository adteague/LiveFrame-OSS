...
from liveframe.config import AspectRatio, LiveframeSettings
from liveframe.exceptions import ClipExtractionError
from liveframe.models import DeduplicatedHighlight, ExtractedClip
...
async def extract_clip(
    ...
    if settings.captions:
        from liveframe.core.captioner import add_captions
